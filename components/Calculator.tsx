...
import { Camera, Send, X, Save, Loader2, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col h-full bg-gray-50 relative">
        ...
        rightElement={
          <>
            ...
            <button
              ...
              className={`flex items-center gap-1 px-4 py-1.5 rounded-full text-sm font-semibold transition-all ${messages.length < 2 || isSaving
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4 pb-36">
        {messages.map((msg) => {
          // Don't render empty model messages (they are handled by the loading bubble state)
          ...
          return (
            ...
            >
              <div
                className={`p-3 rounded-2xl text-sm leading-relaxed shadow-sm whitespace-pre-wrap ${msg.role === 'user'
      ...
      <div className="absolute bottom-[65px] left-0 right-0 bg-white border-t border-gray-200 p-3 z-20">
        ...
        <div className="flex items-end gap-2">
          ...
          <button
            ...
            className={`h-12 w-12 flex items-center justify-center rounded-full transition-all shadow-sm shrink-0 relative ${(!inputText.trim() && !inputImage) || isLoading
              ? 'bg-gray-200 text-gray-400'
